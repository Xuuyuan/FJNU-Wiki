...
=== "旗山校区"
    ...
    目前，校内（及周边）共有 6 个快递站。由此也衍生出了一些专门的快递代取服务，此处不做介绍，自行了解。

    !!! warning "关于圆通快递/京东快递/韵达快递/极兔快递的提示"
        2026 年 8 月起，圆通快递疑似重新搬回校外（即：从【桂五快递服务中心】搬往【师大西门妈妈驿站】），有需要寄取件的请注意平台上显示的地址；京东快递在北区（桂/桃/李/榕苑）直接送到宿舍楼下、不再送至快递站、在南区送至兰苑9号楼菜鸟驿站；韵达快递/极兔快递似乎将重新搬回校内桂五快递服务中心。具体信息待正式开学后更新。
    | 名称 | 营业时间 | 服务快递 | 快递位置 | 寻路指引 |
    | --- | --- | --- | --- | --- |
    | 师大一区邮政所 | 可能为 8:30-19:00 | 邮政（EMS） | 榕苑 2 号楼楼下 | 百草园餐厅麦当劳 WiFi 标志对面 |
    | 桂五快递服务中心 | 大约为 8:30-20:00 | 顺丰、中通、圆通、申通、德邦 | 桂苑 5 号楼旁边 | 桂 5 学生服务中心旁边道路进来 |
    | 师大西门妈妈驿站 | 22:00 锁门 | 极兔、韵达 | 荷塘名郡商业街旗山幼儿园背后 | 出西门直走直到看见赵一鸣后向前28米右转（有驿站指示牌） |
    | 南区菜鸟驿站 | 暑假 9:30-17:00 | 中通、京东 | 兰苑 9 号楼架空层 | 兰苑 7-8 号楼与兰苑 9-11 号楼中间的绿化带内直走到尽头 |
