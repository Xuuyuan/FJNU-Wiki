...
=== "旗山校区"
    ...
    目前，校内（及周边）共有 7 个快递站。由此也衍生出了一些专门的快递代取服务，此处不做介绍，自行了解。

    !!! tip "提示"
        由于快递站点频繁变更，信息存在不准确的可能性。有需要取件的请注意平台上显示的驿站地址。本部分信息修订于 2026 年 8 月 31 日，在此之前的快递遵循旧规则。
        
        京东快递在北区（桂/桃/李/榕苑）直接送到宿舍楼下、不再送至快递站、在南区送至兰苑9号楼菜鸟驿站。需要收取京东快递请注明清楚宿舍楼栋。

    | 名称 | 营业时间 | 服务快递 | 快递位置 | 寻路指引 |
    | --- | --- | --- | --- | --- |
    | 师大一区邮政所 | 可能为 8:30-19:00 | 邮政（EMS） | 榕苑 2 号楼楼下 | 百草园餐厅麦当劳 WiFi 标志对面 |
    | 桂五快递服务中心 | 大约为 8:30-20:00 | 顺丰、中通、圆通、申通、德邦、极兔、韵达 | 桂苑 5 号楼旁边 | 桂 5 学生服务中心旁边道路进来 |
    | 师大西门妈妈驿站 | 22:00 锁门 | 2026/08/31 前到达的极兔、韵达 | 荷塘名郡商业街旗山幼儿园背后 | 出西门直走直到看见赵一鸣后向前28米右转（有驿站指示牌） |
    | 西门京东驿站 | 未知 | 京东（不注明地址） | 保利阅云台入口对面 | 出西门右拐直走至三岔口，左拐直走至“闽北风味”、继续直走到达
    | 南区菜鸟驿站 | 暑假 9:30-17:00 | 中通、顺丰、德邦、京东（南区） | 兰苑 9 号楼架空层 | 兰苑 7-8 号楼与兰苑 9-11 号楼中间的绿化带内直走到尽头 |
    | 协和学院菜鸟驿站 | 可能为 8:30-19:00 | 顺丰、圆通、中通、申通、邮政 | 协和学院篮球场旁 | 协和学院大门出门右转直走 300m |
    | 协和学院多多驿站 | 可能为 9:00-18:00 | 极兔、韵达 | 协和西南门斜对面 | 协和西南门外卖柜对面 |
...
- 旗山校区：福建省福州市闽侯县福建师范大学X（桂/桃/李/榕/兰/荷）苑X号楼
...
旗山校区、仓山校区图书馆的开放时间均为每日 7:30-22:00，旗山 24 小时书房的开放时间为每日 7:30-24:00。每周三 7:00-13:00 期间内务整理、暂停开放。
...
=== "旗山校区及周边"
    ...
    校内仅有建设银行的自助存取款机，位置：北区文化街入口处（李苑 1 号楼旁），师大教育超市对面。
...
- 文化街自习室（店家提供的场地，可能收费）
- 食堂（翠竹园、千叶园、槿灿园都常有自习的同学）
- \*社团活动室（部分社团有自己的活动空间）
- \*基地班自习室（部分学院在学院楼内为基地班成员提供了专用的自习室，如：地理科学学院 - 自资基地班）

可以关注福Star APP（旗山）和福建师范大学微博（仓山）了解每天哪里有空闲教室，笃行楼 3 号门、致广楼 2 号门上的公屏也会显示当天可用的自习教室，自习教室的开放时间为每日 8:00-22:00。
...
自动体外除颤器（AED）是一种急救设备，具有便携式、易于操作、专为现场急救设计、经内置电脑分析和确定发病者是否需要予以电除颤（electric defibrillation），并于判断后自动给予电除颤的功能。
...
文化街有部分店铺会在每年的毕业季（约 4~5 月）推出打印优惠的活动，将价格调整至 0.1 元/张（单面打印）、甚至有商家会压价到 0.05 元/张。与此同时，常有店铺推出类似于 `充 50 元送 30 元` 的活动，若打印需求较大、可以酌情参加。

- 若通过二维码扫描上传文件时提示“文件违规”，请通过打印店电脑上的【爱印通】软件进行打印。
- 若通过打印店电脑进行打印，打印结束后请及时将电脑上的相关资料删除（【爱印通】软件 - 文件列表 - 删除），否则可能有文件泄露的风险。部分商家会在 WPS 上开启文档云同步，请同样重点关注这一部分。
...
旗山校区嘉树园餐厅内设有共享厨房，允许学生自行携带食材做饭。

### 开放时间

- 午间场：10:00 - 13:00（每周一至周六）
- 晚间场：16:00 - 19:00（每周一至周五）

### 场地配置

- 配置 3 组灶台，每组可容纳 1-4 人（预约时精确到组，即 12 人需要预约 3 组）。
- 每组含 2 个炒锅，另设公共烤箱 1 台。
- 共享厨房不收取费用，仅提供水电、基础厨具及餐具。食材、调料需要自备。

### 预约流程

1. 1 人通过微信公众号【福师大小勤】页面底部菜单栏的【特色服务】-【共享厨房】进入小程序发起预约，同时完整填写所有随行人员信息。最早可提前 7 天预约。
2. 审核成功后，在预约时间段内入场，出示学生证或校园卡验证本人身份。
3. 全员需在《使用承诺书》上签字确认，方可使用。
