...
!!! tip "提示"
    下面迎新群可能并非最新迎新群, 可以在其他迎新群询问权威的学长学姐获取。如果需要查询学校当前有注册的社团列表，可以在 福Star APP 中依次选择【学生服务】-【社团管理系统】-【加入社团】。每位学生在系统中的社团信息每年均会清空，**在系统上**同一时间只能加入两个社团（但是实际上参加多少个社团的活动是无所谓的，只是在系统中的才能打印社员证明用来加文体分）。
...
| [网络与信息安全协会](NISA.md) | 933860198 | 2026年 |
