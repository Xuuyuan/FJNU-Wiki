...
学校目前有 3 个校区：仓山校区、旗山校区、河西校区。以学院为单位分配校区。

- 仓山校区：位于市区的老校区。文学院、外国语学院、教育学院（含少数民族预科班）、教师教育学院、网络与继续教育学院（非全日制）在此地办学。
- 旗山校区：位于福州大学城核心位置的新校区。除仓山校区外所有学院均在此地办学。
- 河西校区：位于旗山校区旁、溪源江对岸的校区。福建师范大学协和学院（独立学院）在此地办学。
...
银行卡由学校统一办理，有学校专属卡面，随录取通知书一同发放（2026 年响应了“录取通知书一纸化”政策，银行卡并未随录取通知书发放，可能在开学时发放）。若学生之前无建行的一类卡则默认为一类卡、否则为二类卡。部分学生录取通知书内不会有银行卡，自行另外办理即可，学校会在开学后再进行卡号收集。该建行卡用于学费住宿费代扣（学费住宿费并不只有这一种缴费渠道，详见[费用缴纳](../service/services.md#fee-payment)）、助学贷款返还、师范生补贴发放、奖学金发放等。

学校统一办理银行卡的发卡行：中国建设银行福州仓山分行

- 若要激活银行卡，满 18 周岁的需带上身份证，必要时带上录取通知书（有的银行需要）。
...
新生安全微课是所有学生均需要完成的（其实不做也可以，但是会被辅导员催）新生安全教育线上微课。
