...
体测成绩在测试时不会告知（但可以在测试完毕后的极短时间内自行查看教师屏幕上的数据，50 米、1000 米等部分项目受物理条件限制需要有人帮你查看或无法查看），会在当学期体测工作完成后下发，通过 福Star APP - 体质测试 打开体测系统（或[点击此处进入体测系统](https://tcxt.fjnu.edu.cn)）中的【学年成绩查询】模块进行查询。
