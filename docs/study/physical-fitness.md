...
由体育科学学院的研究生开发的站点：[福师大体育服务指南](http://fjnusport.khromia.art/)。 —— 大体部Tips: 该网站为学生制作的体育支持信息测试平台，不是学校官方平台，也不是线上申请系统，仅用于信息整理和查询。具体办理仍以学校、学院和任课教师发布的最新要求为准。如发现信息有误，可通过网站反馈入口提交意见。

## 体测（体质健康测试） {#fitness-test}

- 以下规则修订于 2026年9月24日，参考资料：[《2026-2027学年第一学期体质测试预约说明》](https://tky.fjnu.edu.cn/e4/db/c10998a451803/page.htm)。
...
体测正测在每学年的 10\~12 月之间分批次进行，补测工作则在次年 3\~5 月进行。毕业班补测工作则详见[此处](#final-test-makeup)。
...
- 旗山校区：体训馆室内田径场（除跑步外的其它项目）、南区田径场（50 米、800/1000 米）
- 仓山校区：综合体育馆（除跑步外的其它项目）、长安山田径场（50 米、800/1000 米）
...
因先天疾病、残疾丧失运动能力的学生、义务服兵役期满退役复学的学生可以申请全学年免测；测试周期内因伤病（至少 6 个月）不能剧烈运动的学生、因访学或其他事由不能参加体测的学生可以申请当学年免测。具体流程如下：
...
!!! info "免测学生的体测分数、评奖评优处理办法"
    === "2025、2026 级学生"
        1. 因先天疾病、残疾丧失运动能力申请免测的学生的当年体测成绩计为当年两学期保健班体育课程成绩的平均值、以该成绩参与评奖评优，在计算毕业成绩时不计入。
        2. 义务服兵役期满退役复学的学生，若申请免测，则当年体测成绩计为 60 分，以该成绩参与评奖评优，在计算毕业成绩时不计入。此类学生可不申请免测而正常参与测试，预约参加体测后成绩按实际测试成绩计算。
        3. 测试周期内因伤病（至少 6 个月）不能剧烈运动的学生可申请当学年免测，免测申请通过后当学年体测成绩按 50 分计，在计算毕业成绩时不计入。
        4. 因访学无法参与体测的学生当年体测成绩计为往年体测成绩的平均值、以该成绩参与评奖评优，在计算毕业成绩时不计入。
    === "2023、2024 级学生"
        所有免测学生的当年体测成绩计为 0 分，以“良好”（80 分）参与评奖评优，在计算毕业成绩时计为“免测”。

        消息口径：《关于福建师范大学2026-2027学年学生体质健康测试安排的通知》五、4. 免测成绩认定自 2025 级学生开始执行，2023 级和 2024 级学生在校期间的评奖评优，其中的免测成绩由各学院参考往年处理办法。
...
【体测正测成绩未达到 60 分】或【未预约测试 且 免测申请未提交或未通过】的同学需要参加 补测，相关工作会在次年 3\~5 月进行，流程与体测正测相同。
...
体测成绩在测试时不会告知（但可以在测试完毕后的极短时间内自行查看教师屏幕上的数据，50 米、1000 米等部分项目受物理条件限制需要有人帮你查看或无法查看），会在当学期末下发，通过 福Star APP - 体质测试 打开体测系统（或[点击此处进入体测系统，仅限校园网](https://tcxt.fjnu.edu.cn)）中的【学年成绩查询】模块进行查询。
...
跑步次数要求每年均不相同，此处给出的次数为 2026-2027 学年第 1 学期的规定。

- 2023 级、2024 级、2025 级“校园健康跑”时限为 2026年8月31日 — 2026年12月27日（第 1 周--第 17 周），计 15 周。
- 2026 级新生“校园健康跑”时限为 2026年9月21日 — 2026年12月27日（第 4 周--第 17 周），计 12 周。

![学期跑步次数要求](./pics/physical-fitness-semester-running-quota.png)
