...
#### 大学英语加分政策 {#english-extend-points}

2026年3月1日起，大学英语推行了新的加分政策。非英语专业本科生大学英语期末考试成绩合格、无旷课记录，可持以下考试成绩及赛事成绩的相关证明（自证明下发之日起一年内有效），按标准对该学期课程加 5 分或 10 分。每学期仅可选择其中一项申请加分，加分后的课程成绩最高不超过 100 分。下表为部分摘录，完整文件请参阅[《关于福建师范大学非英语专业本科生大学英语课程成绩加分管理办法》](./files/关于福建师范大学非英语专业本科生大学英语课程成绩加分管理办法.pdf)。

| 序号 | 类别 | 加分标准 |
| --- | --- | --- |
| 2 | 大学英语四级 CET-4（笔试） | 580-599 分，加 5 分；600 分及以上，加 10 分 |
| 3 | 大学英语四级 CET-4（口试） | 优秀，加 10 分 |
| 4 | 大学英语六级 CET-6（笔试） | 530-549 分，加 5 分；550 分及以上，加 10 分 |
| 5 | 大学英语六级 CET-6（口试） | 优秀，加 10 分 |
| 6 | 雅思（IELTS） | 7-8 分，加 5 分；8.5 分及以上，加 10 分 |
| 7 | 雅思（IELTS）（口语） | 6.5-7.5 分，加 5 分；8 分及以上，加 10 分 |
...
以上课程的分数构成均为 总分 = 平时分 20% + 期中考 20% + 期末考 60%，《线性代数》可能为 总分 = 平时分 30% + 期中考 10% + 期末考 60%。

2025-2026学年第2学期起，《高等数学》课程重修为单独开班，不再跟班上课。重修班上课时间固定为周四、周五晚上。

### 大学体育（一）\~（八） {#college-pe}

《大学体育》由大体部（体育科学学院-大学体育教学部）开设，所有专业（体育科学相关专业除外）均必修，时间跨度为第 1-8 学期，分别学习大学体育（一）\~（八）课程，每门课程 0.5 学分。其中，大学体育（一）\~（四）为模块选课，选课时间分别为第 1 学期期初、第 1 学期期末；大学体育（五）\~（八）课程中校园跑分数占比为 100%（亦可选择线上课程进行替代）。保健班学生的《大学体育》课程以《调适体育》课程替换，详情请见[保健班](../study/physical-fitness.md#health-class)。

大学体育（四）课程中，游泳考核的部分占 20 分。游泳考核在学期末的几周课程内完成，地点为露天游泳池。考核要求：男生 50 米，女生 25 米。根据相关规定，满足以下条件之一、可以提供相关证明的可以以 1500 米跑作为替代。实际执行视不同老师而有所不同。

- 有宗教信仰；
- 患有慢性皮肤疾病（急性不可）；
- 患有慢性中耳炎（急性不可）。

游泳考核并不强制参与，且不参与考核不一定没有对应部分分数（实际上取决于任课老师）。若不打算参加考核，在游泳课程时点完名就可以下课。
...
本课程为 2.0 学分的必修课，在第 1\~6 学期进行学习（每个学期均有），每学期 4 学时。成绩全部来源于第 6 学期提交的 2000 字手写课程论文，无平时分。

### 军事理论 {#military-theory}

本课程为 3.0 学分的必修课，在第 1\~2 学期进行学习（具体哪个学期视专业培养计划安排）。有期中论文要求（可以使用 AI）和统一期末考（开卷 + 上机考试，全部为客观题）。退役义务兵可以申请该课程免修。

《军事理论》课程的在线教学部分为凑学时而开设，实际上并不需要上课/签到。仅需在当学期内完成学习通平台上所有相应任务即可。
...
1. 学生在[教务管理系统](https://jwglxt.fjnu.edu.cn)中查看学期课程表，界面下方的“其它课程”中可以查询到已选上的线上课程信息及上课平台。
2. 根据课程所属的不同平台进行操作：

=== "学校教学云平台（即超星学习通）"
    首次登录时，在登录页面点击【新用户注册】，使用个人手机号实名制注册登录，按照提示设置密码，并绑定单位UC码（单位UC码：1430）及学号，登录成功之后点击个人头像处进行绑定信息确认；已经在手机端注册的同学，与学习通账号密码一致。
=== "中国大学MOOC"
    1. 访问[中国大学MOOC](https://www.icourse163.org)，注册并登录。
    2. 登录后，直接在平台首页搜索“课程名称”或“教师姓名”，找到教务系统选修的对应课程，进入到课程页面后，点击“报名参加”即可成功进入到课程的内容学习。（请注意具体课程的开课时间，部分课程开课时间可能会比较晚）
    3. **在登录平台后，务必定期关注课程的通知公告并及时加入“慕课堂”。最终成绩数据将按照个人昵称进行统计筛选和身份识别，未按要求修改的将无法认定成绩和学分。**
=== "智慧树"
    1. 访问[智慧树](https://www.zhihuishu.com)。
    2. 首次选修该网站课程的需要选择学号登录，初始账号为`学号`，初始密码为 `Zhihuishu@学号后六位`（注意Z大写）。之前有选修过智慧树的用原账号密码直接登录即可。
    3. 请以角标为共享课的课程学习，其他课程学习不计入学分。
...
5. 成绩作废：若公选课为 0 分，可以提供未修读证明以申请成绩作废，这样这门课的成绩就不会显示在成绩单上（相当于从未选过这门课）。需要自行咨询学院教学秘书。

## 教材的购买 {#textbook-purchase}

大一上学期的教材由学校统一预定，必须交钱购买。此后的教材建议自行购买（通过学校购买价格很贵，而且很多书实际上根本没用），但部分学院[马工程系列课程](#marxism-engineering)的教材依然为强制统一订购。《时事报告》全员均强制统一订购，价格为 20 元/本，没有课程需要使用该教材，交完钱就能扔了。
...
| --- | --- | --- | --- | --- |
| 2026-2027 学年 | 第 1 学期第 10-11 周 | 2024 级、2025 级 | 未知 | 未知 |
| 2025-2026 学年 | 第 1 学期第 10-11 周 | 2023 级、2024 级 | 4+2 门校级线下课程 + 3 门院级线下课程 + 4 门线上课程 | 二维码签到 |
| 2024-2025 学年 | 第 2 学期第 7-8 周 | 2022 级、2023 级、2024 级 | 8 门线下课程 + 4 门线上课程 | 二维码/数字码签到 + 签退，签退时需要提交不少于 30 字课程评价 |
...
可供参考使用的站点：[个性化培养周选课工具](https://oss.nekoark.com/gxhpy)。
