...
=== "旗山校区"
    ...
    **大一新生大部分住在四改六人间，部分学院可能在六人间（即李苑 9-11 号楼）。**  
    大二时搬至其它宿舍为四人间，部分学院可能搬到/依然在六人间（即李苑 9-11 号楼）。  
    硕士研究生同理，区别是研一新生是五个人住四改六人间。  
    博士研究生是两人住四人间。

    住在兰苑（即学校南区）的学院：计算机与网络空间安全学院（软件学院）、体育科学学院、音乐学院、美术学院、社会历史学院、传播学院。但该说法并不绝对，（或许是出于宿舍不够用的原因，）计网学院自 2023 级起大量分散在兰苑、桃苑、桂苑、李苑。
...
!!! tip "提示"
    根据[《仓、旗两校区学生宿舍共享洗衣机服务项目中标候选人公示》](https://hqjt.fjnu.edu.cn/e0/44/c4238a450628/page.htm)，2026 年 10 月 1 日起，校内共享洗衣机将更换承包商为厦门悠生活网络科技有限公司。但 福州恰同学信息科技有限公司 本身为 厦门悠生活网络科技有限公司 的全资子公司，实际上可能没有任何变化。

[小依共享洗衣官网，下载 APP 请点此](https://www.qtx2015.com/)

宿舍内统一配备了小依洗衣机。小依洗衣机由 福州恰同学信息科技有限公司 进行管理和维护，按次收费，标准洗为 2 元/次。其损坏报修、安装、拆除均免费，通过 小依APP 内的客服或机身上的联系方式联系工作人员处理即可。
...
- 旗山校区桂苑 6-16 号楼、李苑 9-11 号楼：采用了集中供热水的方式，宿舍中不配备热水器，热水单独收费，价格为 29 元/吨。卫生间喷头下方有二维码，扫码进入微信小程序【乐校通】支付后开水闸才能出水，基本洗一次澡消费在 0.5 元左右。**若余额不足会直接停止供应热水**。
...
根据 [《福建师范大学2026年普通高考招生章程》](https://gaokao.chsi.com.cn/zsgs/zhangcheng/listVerifedZszc--infoId-7633448568,method-view,schId-307.dhtml) 第五章第十八条 的规定，以下是 2026 年的住宿费收费标准，其中本科生常住的宿舍类型已被加粗表示：
...
宿舍水电费每月一结算（暑假则为两个月一并结算），全宿舍一起算，使用工商银行卡缴费。到缴费的时候，楼管会在宿舍楼下和宿舍楼栋群内发布通知。（同账号缴费一次后，后续缴费无需再进行扫码，直接进入 中国工商银行APP - 水电费 进行缴纳即可）

缴费二维码及具体要求见下图。业主姓名统一填写 `福建师范大学`。进行缴费时若有费用为 0 元的项目，请勿勾选，否则缴费时会报错。

[缴费二维码及具体要求](./pics/room-payment.jpg)
...
因特殊原因需要更换宿舍的，需要与辅导员说明原因并进行协商，辅导员同意后由辅导员上报学工处/楼管进行更换。

### 统一更换宿舍 {#dorm-reassignment}

旗山校区大一（或研一）升至大二（或研二）时会在期末周进行统一更换宿舍（部分学院年级也可能不更换），视年级安排而有具体时间的差异。会有少数学院（年级）在新学期开学前才搬离宿舍。
...
进行统一更换宿舍时，年级会安排搬家公司提供行李打包、运输等的服务，相关费用的支出视具体学院情况而有所不同，但大部分学院依然需要由自己支付部分费用（例如：20 元/人）。
...
!!! danger "提示"
    床帘杆的赔偿价格为 10 元/根，钥匙的赔偿价格为 10 元/把。
...
无障碍宿舍为一种特殊的宿舍类型，适用于如疾病、行动不便、身高过高等的特殊情况。无障碍宿舍均为 3 人间，位于李苑 9-11 号楼的 B1 层（即地面层）。笔者仅听说过该类型宿舍，具体情况亦不甚了解，等待后人补充。 TODO
...
- 在常规时间段内宿管会把宿舍楼门打开。若未开门，可以自行通过 福Star APP - 身份码、刷学生卡、刷校园码等方式打开。**（刷脸开门的录入方式：福Star APP - 顶部搜索人脸采集，录入后约 10 分钟生效）**

## 外宿或不住校 {#off-campus-housing}

大一新生原则上不能申请外宿（可以通过长期请假等方式替代实现，有相关案例），大二及以后可以。根据 [《福建师范大学2026年普通高考招生章程》](https://gaokao.chsi.com.cn/zsgs/zhangcheng/listVerifedZszc--infoId-7633448568,method-view,schId-307.dhtml) 第五章第十八条 的规定：生源地、户籍或常住地为福州市鼓楼区、仓山区、台江区、晋安区、闽侯县上街镇、福州高新区的本科新生可申请不住校（但应该需要在开学前及时向辅导员提出申请）。

若有周末长期请假的需求，可以向辅导员提出并说明理由。据了解，部分学院有长期假条机制。
...
若晚查寝打卡平台进一步推行，其它查寝方式可能被逐步取代。以学院具体使用的查寝方式为准。
...
1. 该平台仅限校园网内网使用，即需要连接至校园网才能打开。
2. 由辅导员先行在系统内设置 `舍长、打卡人、年级负责人、班级负责人、自行打卡人` 等角色 及 因外宿/请假等原因而免打卡的学生。
3. 每天晚上门禁时间后 30 分钟内是打卡时间（例如：22:30 门禁，则需要在 22:30-23:00 之间完成打卡），舍长/打卡人需要在此期间打开福Star APP，连接校园网后进入打卡平台为每个舍友刷脸打卡。
4. 打卡平台会录制 4 秒的打卡视频、抽取最后一帧形成打卡照片，将打卡视频及打卡照片一同上传至后台。后台会自动对照片进行二次人脸核验，核验不通过的由辅导员手动校验。
5. 若舍友因临时请假、设备故障等原因未打卡，可以由打卡人手动填写未打卡理由进行手动打卡，辅导员可以在后台看到相关信息及进行核验。

??? tip "注释"
    该平台实际上并不验证定位，编者认为学工处想要以校园内网限制的形式实现变相验证定位。经实测，使用照片同样可以完成打卡（并通过后台的二次人脸核验），故该平台实际制约效果可能有限。
