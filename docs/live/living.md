...
2026年1月起，学校学工处启用[晚查寝打卡平台](https://stucheck.fjnu.edu.cn)。截至2026年3月5日，该平台暂时还仅在 `纪检监察学院2025级` 进行测试，暂不知晓何时应用至全校。

1. 该平台仅限校园网内网使用，即需要连接至校园网才能打开。
2. 由辅导员先行在系统内设置 舍长、打卡人、年级负责人 等角色及因外宿等原因而免打卡的学生。
3. 每天晚上门禁后 10 分钟内是打卡时间，舍长或打卡人需要在此期间打开福Star APP，进入打卡平台给每个舍友刷脸打卡。
4. 打卡平台会录制相应的打卡视频、通过抽帧形成照片，将视频及照片一同上传至后台。后台会对照片进行人脸核验。
5. 若舍友因请假等原因未及时打卡，可以手动填写未打卡理由，辅导员会在后台进行核对。
